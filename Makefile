# This Makefile is for the Bookweb extension to perl.
#
...
#     AUTHOR => [q[Roy Aziz Barera <roy.aziz.tif422@polban.ac.id>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Bookweb]
#     PL_FILES => {  }
#     PREREQ_PM => { Dancer=>q[1.3521], Test::More=>q[0], YAML=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Bookweb.pm]
#     clean => { FILES=>q[Bookweb-*] }
...
TO_INST_PM = lib/Book.pm \
	lib/Book/Result/Author.pm \
	lib/Book/Result/Book.pm \
	lib/Bookweb.pm
...
Bookweb.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Bookweb\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "  - 'Roy Aziz Barera <roy.aziz.tif422@polban.ac.id>'" >> META_new.yml
	$(NOECHO) $(ECHO) build_requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  ExtUtils::MakeMaker: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) configure_requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  ExtUtils::MakeMaker: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "dynamic_config: 1" >> META_new.yml
	$(NOECHO) $(ECHO) "generated_by: 'ExtUtils::MakeMaker version 7.58, CPAN::Meta::Converter version 2.150010'" >> META_new.yml
	$(NOECHO) $(ECHO) "license: perl" >> META_new.yml
	$(NOECHO) $(ECHO) meta-spec: >> META_new.yml
	$(NOECHO) $(ECHO) "  url: http://module-build.sourceforge.net/META-spec-v1.4.html" >> META_new.yml
	$(NOECHO) $(ECHO) "  version: '1.4'" >> META_new.yml
	$(NOECHO) $(ECHO) "name: Bookweb" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Dancer: '1.3521'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "      \"Roy Aziz Barera ^<roy.aziz.tif422^@polban.ac.id^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	$(NOECHO) $(ECHO) "   \"dynamic_config\" : 1," >> META_new.json
	$(NOECHO) $(ECHO) "   \"generated_by\" : \"ExtUtils::MakeMaker version 7.58, CPAN::Meta::Converter version 2.150010\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Bookweb\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Dancer\" : \"1.3521\"," >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Bookweb\" VERSION=\"0.1\">" > Bookweb.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>YOUR APPLICATION ABSTRACT</ABSTRACT>" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Roy Aziz Barera &lt;roy.aziz.tif422@polban.ac.id&gt;</AUTHOR>" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Dancer::\" VERSION=\"1.3521\" />" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Test::More\" />" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"YAML::\" />" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.32\" />" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> Bookweb.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> Bookweb.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> Bookweb.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Book.pm blib\lib\Book.pm \
	  lib/Book/Result/Author.pm blib\lib\Book\Result\Author.pm \
	  lib/Book/Result/Book.pm blib\lib\Book\Result\Book.pm \
	  lib/Bookweb.pm blib\lib\Bookweb.pm 
